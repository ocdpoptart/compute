...
--Default springs
hl.curve("easy", { type = "spring", mass = 1, stiffness = 238.1191, damping = 24.2127933 })
...
hl.config({
	misc = {
		...
		disable_hyprland_logo = false, --if true disables random hyprlandd logo / anime girl background
	},
})
